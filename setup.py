...
METADATA = {
    ...
    'description':      'Put the pictures back together',
    'author':           'telecoda',
    #'author_email':     '',
...
PACKAGEDATA = {
    ...
    'package_dir': {'pickupthepieces': 'pickupthepieces',
                   },
    'packages': ['pickupthepieces',
                ],
    'scripts': ['scripts/pickupthepieces'],
}
...
_DATA_DIR = os.path.join('pickupthepieces', 'data')
data = []
...
data_dirs = [os.path.join(f2.replace(_DATA_DIR, 'data')) for f2 in data]
PACKAGEDATA['package_data'] = {'pickupthepieces': data_dirs}
...
src = []
add_files(src,os.walk('pickupthepieces'))
