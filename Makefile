#fake Makefile for pickupthepieces, to support the common
...
clean:
	...
	rm -f pickupthepieces/*~
	rm -rf bin develop-eggs eggs parts .installed.cfg pickupthepieces.egg-info
